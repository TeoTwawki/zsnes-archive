...
EXTSYM MessageOn,MsgCount,Msgptr,bgcmsung,bgmode
...
EXTSYM Get_MouseData
EXTSYM romispal,MusicRelVol,MusicVol,KeySlowDown
EXTSYM KeyVolUp,KeyVolDown
...
EXTSYM EmuSpeed,SDRatio,FFRatio,lhguimouse,SwapMouseButtons
EXTSYM EMUPause
